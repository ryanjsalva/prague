...
export default class prague extends Component {
...
AppRegistry.registerComponent('prague', () => CodePush( {installMode: CodePush.InstallMode.IMMEDIATE, updateDialog: true } ) (prague));
